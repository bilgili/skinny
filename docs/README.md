...
| [HostModules.md](HostModules.md) | Python module map, front-end bring-up, the session snapshot owner, the renderer carve-out pattern, the device-free pure core |
