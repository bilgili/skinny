...
| MLT integrator — PSSMLT over BDPT (wavefront, flat materials, RGB + spectral) | ✅ (`WavefrontMltPass`) | ✅ (`MetalWavefrontMltPass`; equivalent to Vulkan within the film-splat quantum, **not** bit-identical — see [docs/MetropolisLightTransport.md](docs/MetropolisLightTransport.md#cross-backend-equivalence)) |
