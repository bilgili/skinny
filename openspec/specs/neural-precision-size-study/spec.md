...
full precision, reduced-precision weight storage, and reduced-precision MLP compute —
while the rational-quadratic spline evaluation and the reported solid-angle pdf SHALL
remain at full precision in every mode.
