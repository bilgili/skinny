...
Grid-density participating media: NanoVDB density grids rendered as free-standing volumes through
the existing majorant/null-collision medium seam, on both backends and both execution modes.
