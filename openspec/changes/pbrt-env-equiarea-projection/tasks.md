...
- [ ] 4.4 *(deferred)* Full `sss_dragon_small` Metal **wavefront** render vs pbrt-v4 reference to confirm azimuth + handedness within corpus relMSE/FLIP; do under the RAM guard (megakernel OOMs the dragon)
